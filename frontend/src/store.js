...
const reducer = combineReducers({ userLogin: userLoginReducer, userRegister: userRegisterReducer, postsDetails: postsAddReducer, allPosts: postsGetReducer, editPost: postsEditReducer, deletePost: postsDeleteReducer });
